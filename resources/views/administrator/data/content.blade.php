...
<div class="card card-primary">
    ...
    <form action="{{ route('data.content.update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <input type="text" name="phone5" value="{{$data->phone5}}" class="form-control" placeholder="Teléfono whatsapp">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="text" name="youtube" value="{{$data->youtube}}" class="form-control" placeholder="Link del canal de youtube">
            </div>
